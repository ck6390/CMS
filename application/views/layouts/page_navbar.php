	...
	<div class="sidebar-collapse">
		...
		<ul class="nav metismenu" id="side-menu">
			...
			<?php }elseif($this->session->userdata['roleID'] == '1' || $this->session->userdata['roleID'] == '7'){ ?>
				...
				<li><a href="<?= site_url('students') ?>"> STUDENT LISTS</a></li>
		 		<li>
		   ...
		   <?php  } ?>
			...
			<li>
				...
				<ul class="nav nav-second-level collapse">
					...
					<li>
						<a href="#"> <span class="nav-label">RESTRICTION</span><span class="fa arrow"></span></a>
						<ul class="nav nav-third-level collapse">
							<li>
								<a href="<?= site_url('setting/restrictions/add') ?>"> Add Restriction</a>
							</li>
							<li>
								<a href="<?= site_url('setting/restrictions') ?>">List Restriction</a>
							</li>
						</ul>
					</li>
					<!-- Payment Mode -->
					<li>
						<a href="#"> <span class="nav-label">FINANCIAL</span><span class="fa arrow"></span></a>
						<ul class="nav nav-third-level collapse">
							<li>
								<a href="<?= site_url('setting/financial_years/add') ?>"> Add Financial </a>
							</li>
							<li>
								<a href="<?= site_url('setting/financial_years') ?>">List Financial</a>
							</li>
						</ul>
					</li>
					<!-- Payment Mode -->
				...
				<ul class="nav nav-second-level collapse">
					...
					<li>
						...
						<ul class="nav nav-third-level collapse">
							...
							<li>
								<a href="<?= site_url('sms/general_sms') ?>">General Send SMS</a>
							</li>
						</ul>
					</li>
					<li>
			...
			<?php } ?>
			<?php if($this->session->userdata['roleID']=='1' || $this->session->userdata['roleID']=='12'){ ?>
			<li>
				<a href="#" class="text-uppercase"><i class="fa fa-user"></i> <span class="nav-label">Inventory Manag.</span><span class="fa arrow"></span></a>
				<ul class="nav nav-second-level collapse">
				<?php if($this->session->userdata['roleID']=='1' || $this->session->userdata['roleID']=='12'){ ?>
					<li>
						...
						<ul class="nav nav-third-level collapse">							
							<li>
								<a href="<?= site_url('inventry/items') ?>"> List</a>
							</li>						
							<li>
								<a href="<?= site_url('inventry/items/add') ?>"> Add</a>
							</li>
						</ul>
					</li>
					<li>
						<a href=""> <span class="nav-label">Inventory</span><span class="fa arrow"></span></a>
						<ul class="nav nav-third-level collapse">							
							<li>
								<a href="<?= site_url('inventry/inventories') ?>"> List</a>
							</li>						
							<li>
								<a href="<?= site_url('inventry/inventories/add') ?>"> Add</a>
							</li>
							<li>
								<a href="<?= site_url('inventry/inventories/inentry_statement') ?>">Inventory Statement</a>
							</li>
						</ul>
					</li>
					<?php } if($this->session->userdata['roleID']=='1' || $this->session->userdata['roleID']=='12'){ ?>	
						<li>
							<a href="<?= site_url('inventry/sales/add') ?>"> Receipt</a>
						</li>
	
				<?php } if($this->session->userdata['roleID']=='1' || $this->session->userdata['roleID']=='12'){ ?>					
					<li>
						<a href=""> <span class="nav-label">Receipt Report</span><span class="fa arrow"></span></a>
						<ul class="nav nav-third-level collapse">							
							<li>
								<a href="<?= site_url('inventry/sales') ?>"> Receipt List</a>
							</li>						
							<li>
								<a href="<?= site_url('inventry/sales/receipt_statement') ?>">Receipt Statement</a>
							</li>
						</ul>
					</li>					
				</ul>
			...
			<li>
				...
				<ul class="nav nav-second-level collapse">
					...
					<li>
						<a href="<?= site_url('admin/backup') ?>"> BACKUP</a>
					</li>
