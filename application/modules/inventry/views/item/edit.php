			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Edit Item [<?= $info->item_name ?>]</h5>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group <?php if(form_error('item_name')) echo 'has-error'; ?>">
									<?php echo form_label('Item Name <small class="text-danger">*</small>', 'item_name', array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-9">
										<?php
										echo form_input(array(
											...
											'value' => set_value('item_name', $info->item_name),
											'required' => 'true'
										));
