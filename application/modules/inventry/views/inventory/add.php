			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-md-10">
								<div class="form-group <?php if(form_error('item_on_date')) echo 'has-error'; ?>">
									<?php echo form_label('Date of purchasing<small class="text-danger">*</small>', 'item_on_date', array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-9">
										<?php
										echo form_input(array(
											...
											'id' => 'data_1',
											'value' =>  set_value('item_on_date'),
											'required' => 'true',
										));

										echo form_error('item_on_date'); ?>
									</div>
								</div>
								<div class="form-group <?php if(form_error('item_id')) echo 'has-error'; ?>">
									<?php echo form_label('Item Name<small class="text-danger">*</small>', 'item_id', array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-9">
										<?php
										$dropdown[null] = '== Please select one option ==';
										foreach ($items as $item) {
                                           $dropdown[$item->id]=$item->item_name;
										}
								...
								<div class="form-group <?php if(form_error('sale_price')) echo 'has-error'; ?>">
									<?php echo form_label('Sale Price<small class="text-danger">*</small>', 'sale_price', array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-9">
										<?php
										echo form_input(array(
											'type' => 'number',
