				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-md-12">								
								<div class="col-sm-3">
									<div class=" <?php if(form_error('item_id')) echo 'has-error'; ?>">
									<?php echo form_label('Item Type<small class="text-danger">*</small>', 'item_id', array('class' => ' control-label')); ?>
						  ...
						  <thead>								
							...
							<?php foreach ($infos as $info) :?>
								...
								<tr>
									...
									<td id="total1"><?php echo $info->item_name; ?> </td>
									<td id="total1"><?php echo $info->agency_name; ?> </td>
									<td><?php echo $info->bill_ref_no; ?> </td>
									<td><?php echo $info->payment_mode_name; ?> </td>
									<td><?php echo $info->item_on_date; ?> </td>
