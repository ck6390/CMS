						...
						<table class="table table-striped table-bordered table-hover dataTablesView">
							...
							<?php
								...
								<tr>
									...
									<td>
										<?= htmlspecialchars($list->item_on_date,ENT_QUOTES,'UTF-8') ?>
									</td>
									<td>
									...
									<td>
										<?= htmlspecialchars($list->sale_price,ENT_QUOTES,'UTF-8') ?>
									</td>
									<td>
										<?php 
									...
									<td class="thStyle">
										...
										<span class="badge badge-default"><?php echo "Pay Mode:- ".$list->payment_mode_name; ?></span><br>
