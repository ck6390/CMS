        ...
        <table class="table table_data table-bordered m-b-none ">
            <tbody>
                ...
                <tr>
                    ...
                    <p class="pStyle"><?php echo 'Student Name:- '.$info->student_full_name;?></p>
                    <p class="pStyle"><?php echo 'Admission No:- '.$info->admission_no;?></p>                     
                    </th>
                    <th>Receipt Date :- <?php echo $info->sale_on_date;?></th>
                </tr>
                <tr>
                    <th>Sno</th>
                    <th>Item</th>
                ...
                <?php $sn++;} }?>
                <tr>
                    <th colspan="3"><p class="th_remark">Payment Mode :- <?php echo $info->payment_mode_name;?><br/>
                        Transaction No :- <?php if(!empty($info->transaction_no) && isset($info->transaction_no)){echo $info->transaction_no;}?></p> 
                    </th>
                    <th>Total Amount :-</th>
                    <th><p><?php echo $info->total_price;?></p></th>
                </tr>
                <tr>
                    <th colspan="5" height="60px;" ><p class="th_remark">Remark :- <?php echo $info->remark;?></p></th>
