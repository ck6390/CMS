					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-md-10">
								...
								<div class="form-group <?php if(form_error('sale_on_date')) echo 'has-error'; ?>">
									<?php echo form_label('Receipt Date<small class="text-danger">*</small>', 'sale_on_date', array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-9">
										<?php
										echo form_input(array(
											...
											'name' => 'sale_on_date',
											'class' => 'form-control',
											'placeholder' => 'sale on Date',
											'id' => 'data_1',
											'value' =>  set_value('sale_on_date'),
											'required' => 'true',
										));

										echo form_error('sale_on_date'); ?>
									</div>
								</div>
								...
								<?php //var_dump($inventories);die();
								foreach($inventories as $inventory){ ?>

									<div class="form-group">
								<?php echo form_label($inventory->item_name, $inventory->item_name, array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-1">
										<label class="checkbox-inline"> 
										<input type="checkbox" id="inv_<?= $inventory->id; ?>" name="inventory_id[]" value="<?= $inventory->id; ?>" class="check_box">
										<input type="hidden" id="sid_<?= $inventory->id; ?>" name="item_id[]" value="<?= $inventory->item_id; ?>" disabled="disabled"> 
										<input type="hidden" id="sname_<?= $inventory->id; ?>" name="item_name[]" value="<?= $inventory->item_name; ?>" disabled="disabled"> 
										</label>
									</div>
									<div class="col-sm-2">
										<?php
									...
									<div class="col-sm-2">
										...
										echo form_input(array(
											...
											'name' => 'unit_price[]',
											'class' => 'form-control',
											'id' => 'unit_price_'.$inventory->id,
											'placeholder' => 'Unit Price',
											'value' =>  set_value('unit_price',$inventory->sale_price),
											'readonly' => 'true',
											'disabled' => 'disabled',
										));?>
									</div>
