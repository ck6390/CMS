...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-8">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="<?= site_url("super_admin/{$this->misc->_getClassName()}/employee/{$this->uri->segment('3')}") ?>"><span class="text-capitalize">Profile</span></a>
			</li>
			<li class="active">
            ...
            <div class="row">
            	<div class="ibox float-e-margins m-t">
                	...
                	<?php
						...
						echo form_open("super_admin/{$this->misc->_getClassName()}/employee/{$info->emp_p_id}", $attr); ?>
											...
											<td>
												<?php 
													if(!empty($list->leave_limit)){
														echo $cl= get_cl($info->emp_p_id,$list->leave_p_id);
														...
														//echo number_format((float)($cl / 12), 2, '.', '');
													//echo $consumed_leave."\n";	 
													//echo $list->leave_p_id;
												//echo $consumed_leave = number_format((float)$consumed_leave * ($list->leave_limit / 12), 2, '.', '');
													}
