						...
						<table class="table table-striped table-bordered table-hover dataTablesView">
							...
							<?php
								...
								<tr>
									...
									<td>
			                       		<a href="<?=base_url().'index.php/super_admin/emp_leave_history_status/'.$list->emp_id."/".$list->status."/".$list->emp_leave_id?>">
			                       			<?php echo ($list->status) ? '<span class="btn btn-info btn-xs"><i class="fa fa-check"></i> Active</span>' : '<span class="btn btn-xs btn-warning"><i class="fa fa-ban"></i> Inactive</span>'?></a>
