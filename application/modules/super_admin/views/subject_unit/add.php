					...
					<table class="table table-striped table-bordered table-hover dataTablesView">
						...
						<?php
							...
							<tr>
								...
								<td><?= '<span class="badge badge-primary">'.htmlspecialchars($list->subject_name." [ ".$list->subject_code." ]",ENT_QUOTES,'UTF-8').'</span></br>'.'<span class="badge badge-success">Branch : '.htmlspecialchars($list->branch_name." [ ".$list->branch_code." ]",ENT_QUOTES,'UTF-8').'</span></br>'.'<span class="badge badge-success">Semester : '.htmlspecialchars($list->semester_name,ENT_QUOTES,'UTF-8').'</span>' ?></td>

								<td><?= '<span class="badge badge-primary">'.htmlspecialchars($list->unit_number,ENT_QUOTES,'UTF-8').'</span>' ?></td>

								<td><?= '<span class="badge badge-primary">'.htmlspecialchars($list->lecture_required,ENT_QUOTES,'UTF-8').'</span>' ?></td>

								<td><?= '<span class="badge badge-primary">'.htmlspecialchars($list->extra_lecture,ENT_QUOTES,'UTF-8').'</span>' ?></td>
								...
								<td>
									<a href="<?php echo site_url("{$this->misc->_getClassName()}/subject_unit_edit/{$list->emp_subject_unit_p_id}"); ?>" class="btn btn-success btn-xs">
            ...
            <div id="tab-2" class="tab-pane ">
                <div class="panel-body">
                    <div class="col-md-12">
						...
						echo form_open("{$this->misc->_getClassName()}/subject_unit", $attr); ?>
							...
							<div class="col-sm-12">
								<div class="form-group <?php if(form_error('branch-id')) echo 'has-error'; ?>">
									...
									echo form_dropdown(array(
										'name' => 'branch-id',
										'class' => 'form-control select2_one for_subject',
										'required' => 'true'
									), $_branch);
							...
							<div class="col-sm-12">
								<div class="form-group <?php if(form_error('subject-id')) echo 'has-error'; ?>">
									...
									// ), $_subject);
										...
										<select id="subjectDropdown" name="subject-id" class="form-control select2_one" required="true"></select>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="col-sm-12">
								<div class="form-group <?php if(form_error('lecture-req')) echo 'has-error'; ?>">
										<?php echo form_label('Lecture Required <small class="text-danger">*</small>', 'lecture-req', array('class' => 'control-label'));
										...
										echo form_input(array(
											...
											'class' => 'form-control',
											'required' => 'true',
											'value' => set_value('lecture-req')

										));

										 echo form_error('lecture-req'); ?>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="col-sm-12">
								<div class="form-group <?php if(form_error('extra-lecture')) echo 'has-error'; ?>">
										 <?php //echo form_label('Extra Lecture <small class="text-danger">*</small>', 'extra-lecture', array('class' => 'control-label'));

										// echo form_input(array(
										// 	'type' => 'text',
										// 	'name' => 'extra-lecture',
										// 	'class' => 'form-control',
										// 	'value' => set_value('extra-lecture')
