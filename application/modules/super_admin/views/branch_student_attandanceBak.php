							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										$get_holiday_sun = getSundays($get_holiday->start_date ,$get_holiday->end_date);
										$total_holiday = $get_holiday->days-count($get_holiday_sun);								
						...
						<table id="day_statement" class="table table-striped table-bordered table-hover ">
							...
							<?php 
								...
								foreach($unique as $info){
									...
									$i++; 
									//var_dump(expression)
									//var_dump(getStudents()->student_roll);
								?>
								<tr>
