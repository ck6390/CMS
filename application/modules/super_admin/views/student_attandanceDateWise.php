						...
						<table class="table  table-striped table-bordered table-hover day_attandance">
							<tbody>
								...
								<tr>
									...
									<td>
										<?php 
										$get_holiday = get_holidays(date('Y-m-d',strtotime($report['endDate'])),date('Y-m-d',strtotime($report['startDate'])));
										
										$get_all_sun = getSundays(date('Y-m-d',strtotime($report['endDate'])),date('Y-m-d',strtotime($report['startDate'])));
								...
								<tr>
									...
									<td>
										<?= $total_lecture = count($total_lecture); ?>
									</td>
								</tr>
							</tbody>
						</table>
						<table  class="table  table-striped table-bordered table-hover day_attandance ">
							...
							<?php
								...
								<tr>
									...
									<td><?= '<strong> '.htmlspecialchars($list['att_status'] == "A" ? "Absent" : "Present",ENT_QUOTES,'UTF-8').'</strong>'; ?></td>
