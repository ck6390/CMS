                            	...
                            	<table class="table table-bordered table-hover">
                                	...
                                	<tbody>
	                                    ...
	                                    if($book->paid_status == "paid" && $book->is_active == '1'){ ?>
	                                    	<a href="<?php echo site_url("library/{$this->misc->_getClassName()}/book_return/{$info->student_p_id}/{$book->book_p_id}/{$book->book_issue_p_id}"); ?>"class="btn btn-primary btn-xs"><i class="fa fa-undo"></i> <strong><?php echo "Book - ".$i." [ Acc No- ".$book->acc_no." ]";?> </strong> Return </a>
	                                ...
	                                <?php }else{ ?>
	                                	<a href="<?php echo site_url("library/{$this->misc->_getClassName()}/book_return/{$info->student_p_id}/{$book->book_p_id}/{$book->book_issue_p_id}"); ?>"class="btn btn-primary btn-xs"><i class="fa fa-undo"></i> <strong><?php echo "Book - ".$i." [ Acc No-".$book->acc_no." ] [ Fine Amount - ".$total_fine." ] ";?> </strong> Return </a>
	                                <?php } } ?>
                                    </td>
