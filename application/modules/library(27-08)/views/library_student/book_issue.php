				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							...
							echo form_open("library/{$this->misc->_getClassName()}/book_issue/{$info->student_p_id}", $attr); ?>
							<div class="col-md-12">
							...
							<div class="text-left" data-id="<?php echo "1".$info->student_unique_id;?>">
								<span class="badge student_verify badge-primary">Click To Verify</span>
								<br>
								<span id="successMessage" class="badge student_verify badge-primary"> </span>
							</div>
							<div class="text-right">
								<button class="btn btn-primary" id="issue_btn" type="submit">Save</button>
							</div>
							<?php echo form_close(); ?>
						</div>	
					</div>
