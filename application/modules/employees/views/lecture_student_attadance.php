				...
				<div class="ibox-content">
					...
					<div class="table-responsive">
						...
						<div class="row">
								...
								<div class="col-md-4 ">
									<div class="col-sm-12">
										<div class="form-group <?php if(form_error('unit-id')) echo 'has-error'; ?>">
											...
											// 	'fk_emp_id' => $info->employee_id,
											// 	'fk_subject_id' => $info->fk_subject_id,
											// 	'is_active' => '1',
											// 	'deleted' => '0' 
											// );
											// $_units = $this->mdl_sub_unit->employee_lecture_units($data);

											
											// $result = array();
											// foreach($_units as $value){
											// 	//print_r($value->unit_id);
											// 	$data = array(

									  //               'subject_unit_p_id' => $value->unit_id,
									  //               'is_active' => '1'
									  //           );
									  ...
									  //       }
											...
											// 	'type' => 'hidden',
											// 	'readonly' => 'true',
											// 	'value' => set_value('emp-id',$info->employee_id)
											// ));
											...
											// 	'type' => 'hidden',
											// 	'readonly' => 'true',
											// 	'value' => set_value('subject-id',$info->fk_subject_id)
											// ));
											
											// echo form_error('unit-id'); ?>
											<!--select name="unit-id" class="form-control select2_one">

												<?php 
												// 	echo "<option value=''>==please select one option ==</option>";
												// foreach( $result as $unitname){
												// 	echo "<option value='$unitname->subject_unit_p_id'> $unitname->unit_number</option>";
												// }
												?>
											</select-->
										</div>
								...
								<div class="col-md-4">
									<div class="col-sm-12">
										<div class="form-group <?php if(form_error('startDt')) echo 'has-error'; ?>">
											<div id="dt1"></div>
											<?php
											// echo form_label('Start Date <small class="text-danger">*</small>', 'startDt');
											
											// echo form_input(array(
											// 	'class' => 'form-control',
											// 	'readonly' => 'true',
											// 	'id' => 'Dt',
											// 	'value' => set_value('startDt')
											// ));
											
											// echo form_error('startDt'); ?>
