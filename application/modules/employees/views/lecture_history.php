						...
						<table class="table table-striped table-bordered table-hover dataTablesView">
							...
							<?php
								...
								<tr>
									...
									<td>
										<?php 
										$semester =$list->fk_semester_id;

										$branch = $list->fk_branch_id;
									...
									<td> <span data-toggle="modal" onclick="student_attendance_list(<?php echo $list->lecture_p_id;?>)" class="btn btn-primary btn-xs"> <i class="fa fa-eye"></i> </span></td>
								</tr>
								<?php }
							} ?>
							</tbody>
