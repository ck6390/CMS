...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-8">
		<h2><span class="text-capitalize"> Library Fine<!-- <?= str_replace('_', ' ', $this->misc->_getClassName()) ; ?> --></span></h2>
		<ol class="breadcrumb">
			<li>
				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							...
							echo form_open("library/{$this->misc->_getClassName()}/add_fine/{$info->student_p_id}", $attr); ?>
