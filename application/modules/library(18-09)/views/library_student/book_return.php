				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							...
							echo form_open("library/{$this->misc->_getClassName()}/book_return/{$info->student_p_id}/{$lists->acc_no}/{$lists->book_issue_p_id}", $attr); ?>
							<?php 
								...
								<div class="form-group <?php if(form_error('call-no')) echo 'has-error'; ?>">
									<?php echo form_label('Call No.', 'call-no');
										...
										echo form_input(array(
											...
											'name' => 'call-no',
											'class' => 'form-control',
											'value' => set_value('call-no', $this->mdl_book->get($lists->acc_no)->call_no),
											'placeholder' => 'Call No.',
											'readonly' => 'true'
										));
								...
								<div class="form-group <?php if(form_error('author-name')) echo 'has-error'; ?>">
									<?php echo form_label('Author Name', 'author-name');
										...
										echo form_input(array(
											...
											'name' => 'author-name',
											'class' => 'form-control',
											'value' => set_value('author-name', $this->mdl_book->get($lists->acc_no)->author_name),
								...
								<div class="form-group <?php if(form_error('stream')) echo 'has-error'; ?>">
									<?php echo form_label('Stream', 'stream');
										...
										echo form_input(array(
											...
											'name' => 'stream',
											'class' => 'form-control',
											'value' => set_value('stream', $this->mdl_book->get($lists->acc_no)->stream),
											'placeholder' => 'Stream',
											'readonly' => 'true'
										));
								...
								<div class="form-group <?php if(form_error('course')) echo 'has-error'; ?>">
									<?php echo form_label('Course', 'course');
										...
										echo form_input(array(
											...
											'name' => 'course',
											'class' => 'form-control',
											'value' => set_value('course', $this->mdl_book->get($lists->acc_no)->course),
											'placeholder' => 'Course',
											'readonly' => 'true'
										));
