...
<div class="wrapper wrapper-content">
	...
	echo form_open("setting/{$this->misc->_getClassName()}/edit/{$info->floor_p_id}", $attr); ?>
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Edit Floor[<?= $info->floor_name ?>]</h5>
								...
								<div class="form-group <?php if(form_error('floor-name')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_input(array(
											...
											'value' => set_value('floor-name', $info->floor_name),
											'required' => 'true'
										));
								...
								<div class="form-group <?php if(form_error('block-name')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										<div id="floorDropdown">
												<select name="block-name" class="form-control select2_one"> 
												<option value="<?php echo $info->block_id?>"><?php echo $this->mdl_block->get_single_value_by_id('block',$info->block_id,'block_name');?></option>
											</select>
										</div>
								...
								<div class="form-group <?php if(form_error('floor-description')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_textarea(array(
											...
											'value' => set_value('floor-description', $info->description)
										));
