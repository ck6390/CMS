						...
						<div class="row">
							<div class="col-md-10 col-sm-12">
								<div class="form-group <?php if(form_error('purpose-name')) echo 'has-error'; ?>">
									<?php echo form_label('Purpose Name <small class="text-danger">*</small>', 'purpose-name', array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-9">
										<?php 
