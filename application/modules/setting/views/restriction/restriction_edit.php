...
<div class="wrapper wrapper-content">
	...
	echo form_open("setting/{$this->misc->_getClassName()}/edit/$info->restriction_p_id", $attr); ?>
		<div class="row">
			<div class="col-md-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Edit Restriction <span class="text-success">[<?= $info->restriction ?>]</span></h5>
								...
								<div class="form-group <?php if(form_error('restriction')) echo 'has-error'; ?>">
									...
									<div class="col-sm-5">
										...
										echo form_input(array(
											...
											'value' => set_value('restriction',$info->restriction),
											'required' => 'true'
										));
...
<!-- 								</div>
							...
							<div class="form-group <?php if(form_error('description <small class="text-danger">*</small>')) echo 'has-error'; ?>">
