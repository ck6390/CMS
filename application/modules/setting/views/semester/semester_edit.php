...
<div class="wrapper wrapper-content">
	...
	echo form_open("setting/{$this->misc->_getClassName()}/edit/$info->semester_p_id", $attr); ?>
		<div class="row">
			<div class="col-md-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Edit Semester <span class="text-success">[<?= $info->semester_name ?>]</span></h5>
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-md-10">
								<div class="form-group <?php if(form_error('semester-name')) echo 'has-error'; ?>">
									<?php echo form_label('Semester Name <small class="text-danger">*</small>', 'branch-name', array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-9">
										<?php 
										echo form_input(array(
											...
											'value' => set_value('semester-name',$info->semester_name),
											'required' => 'true'
										));

										echo form_error('semester-name'); ?>
									</div>
								</div>
