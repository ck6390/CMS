...
<div class="wrapper wrapper-content">
	...
	echo form_open("setting/{$this->misc->_getClassName()}/edit/$info->cast_category_p_id", $attr); ?>
		<div class="row">
			<div class="col-md-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Edit Cast Category <span class="text-success">[<?= $info->cast_category ?>]</span></h5>
								...
								<div class="form-group <?php if(form_error('cast-category')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_input(array(
											...
											'value' => set_value('cast-category',$info->cast_category),
											'required' => 'true'
										));
