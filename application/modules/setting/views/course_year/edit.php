...
<div class="wrapper wrapper-content">
	...
	echo form_open("setting/".$this->misc->_getClassName()."/edit/$info->course_year_p_id", $attr); ?>
		<div class="row">
			<div class="col-md-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Edit Course Year <span class="text-success">[<?= $info->course_year_name ?>]</span></h5>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group <?php if(form_error('course-year')) echo 'has-error'; ?>">
									<?php echo form_label('Course Year <small class="text-danger">*</small>', 'course-year', array('class' => 'col-sm-3 control-label')); ?>
									<div class="col-sm-9">
										<?php 
										echo form_input(array(
											...
											'name' => 'course-year',
											'class' => 'form-control',
											'value' => set_value('course-year',$info->course_year_name),
											'required' => 'true'
										));
