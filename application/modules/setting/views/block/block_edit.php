...
<div class="wrapper wrapper-content">
	...
	echo form_open("setting/{$this->misc->_getClassName()}/edit/{$info->block_p_id}", $attr); ?>
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Edit Block [<?= $info->block_name ?>]</h5>
								...
								<div class="form-group <?php if(form_error('block-id')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_input(array(
											...
											'name' => 'block-id',
											'class' => 'form-control',
											'value' => set_value('block-id', $info->block_id),
											'required' => 'true',
											'readonly' => 'true',
										));
								...
								<div class="form-group <?php if(form_error('block-name')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_input(array(
											...
											'value' => set_value('block-name', $info->block_name),
											'required' => 'true'
										));
								...
								<div class="form-group <?php if(form_error('block-description')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_textarea(array(
											...
											'value' => set_value('block-description', $info->discription)
										));
