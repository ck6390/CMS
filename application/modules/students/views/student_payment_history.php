						...
						<table class="table table-striped table-bordered table-hover dataTablesView">
							...
							<?php
								...
								<tr>
									...
									<td><?= '<strong> '.htmlspecialchars($list->fee_type_name,ENT_QUOTES,'UTF-8').'</strong><strong> '.htmlspecialchars($list->hostel_charge_month ?    $list->hostel_charge_month : "",ENT_QUOTES,'UTF-8').'</strong>'; ?></td>
									...
									<td>
										<a href="<?php echo site_url("accounting/invoices/view/".$list->invoice_p_id); ?>" class="btn btn-primary btn-xs">
											<i class="fa fa-eye"></i>
										</a>
						...
						<table class="table table-striped table-bordered table-hover dataTablesView">
							...
							<?php
								...
								<tr>
									...
									<td><?php if($payment_history->fee_structure_title){
										echo $payment_history->fee_structure_title;
									}elseif($payment_history->fee_type_name){
										echo $payment_history->fee_type_name ." ".$payment_history->hostel_charge_month ;
									} ?></td>
