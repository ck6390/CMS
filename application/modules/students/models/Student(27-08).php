...
{	
	...
	*/
    ...
    {
    	$this->db->select("students.student_p_id,students.admission_no,students.student_roll,students.registration_no,students.fk_semester_id,students.fk_course_year_id,student_unique_id,student_full_name,students.is_active,admission_status,hostel_status, sessions.session_name, branches.branch_code");
