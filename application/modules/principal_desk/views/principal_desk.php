									...
									<?php }elseif(empty($holidays)){ ?>
										...
										<tr>
											...
											<td>
												...
												<?= htmlspecialchars($day_attadance->employee_id,ENT_QUOTES,'UTF-8')." - ".htmlspecialchars($day_attadance->emp_name,ENT_QUOTES,'UTF-8')?>

											</td>

											<td class="">

												<?= $today_attandance['attendance_time']?>
											...
											<td><?= $today_attandance['out_time'] ?></td>
