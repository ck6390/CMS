						  ...
						  <tbody>								
							...
							<?php 
								...
								<tr>
									...
									<td id="total1"><?php echo $stu[$info->student_id]; ?><br><?php echo $info->student_id; ?></td>
									<!-- <td><?php echo $add[$info->student_id]; ?></td> -->
									<td><?php echo $info->sell_on_date; ?> </td>
									<td>
									...
									<td>
										<?php echo $this->mdl_pay_mode->get($sell_infos['pay_mode'])->payment_mode_name;?>
									</td>
									<td><?php echo $sell_infos['transaction_no'];?></td>
									<td><?php echo $sell_infos['total_price'];?></td>
								</tr>
								<?php }endforeach; ?>
								<tr>
