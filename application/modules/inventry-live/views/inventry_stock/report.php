					...
					<div class="ibox-content" id="dvContainer">
						...
						<table id="day_statement" class="table table-striped table-bordered table-hover ">
							...
							<?php
								...
								<tr>
									<th colspan="3" >
									Date Of Purchasing :- <?php echo $inventories->stock_on_date;?><br>
									Stock Name :- <?php echo $s_array[$inventories->stock_id];?><br/>
									Quantity :- <?php echo $inventories->quantity;?><br/>
									Unit Price :- <?php echo $inventories->purchase_price;?>
									<br/>
									Sell Price :- <?php echo $inventories->sell_price;?>
									<br/>
									Total Amount :- <?php echo $inventories->total_amount;?>

							      </th>
								<th colspan="3" class="theadStyle">
									Agency Name :- <?php echo $inventories->agency_name; ?><br/>
										Bill No :- <?php echo $inventories->bill_ref_no; ?><br>
								  <?php echo "Pay Mode:- ".$this->mdl_pay_mode->get($inventories->pay_mode)->payment_mode_name; ?><br/>
									Transaction No :- <?php echo $inventories->transaction_no;?>
								</th>
									<!-- <th>Amount</th> -->
								</tr>
								<?php }  ?>
							...
							<?php 
								...
								foreach ($sell_info as $sell) {
									$item_info = json_decode($sell->sell_info, true);
									foreach ($item_info['items'] as $items) {
									if($items['inventry_id'] == $inv_id){
										$item['stock_name'] = $items['stock_name'];
										$item['quantity'] = $items['quantity'];
										$item['unit_price'] = $items['unit_price'];
										$item['sub_price'] = $items['sub_price'];
							?>
								<tr>
									<td><?= $sell->student_id ?></td>
									<td><?= $sell->student_full_name ?></td>
