        ...
        <div class="col-md-3">
            <div class="ibox float-e-margins">
	            ...
	            <div class="ibox-content profile-content">
	                ...
	                <div class="bg-danger p-xs b-r-sm"> Total Hostel Due : <?php echo $hostel_dues->due_amount ? $hostel_dues->due_amount : 0.00; ?></div>
				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							...
							echo form_open("hostel/{$this->misc->_getClassName()}/fee_fine/{$info->student_p_id}", $attr); ?>
