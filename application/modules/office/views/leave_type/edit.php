...
<div class="wrapper wrapper-content">
	...
	echo form_open("office/{$this->misc->_getClassName()}/edit/" . $info->leave_p_id, $attr); ?>
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Edit Leave Type <span class="text-success">[<?= $info->leave_name ?>]</span></h5>
						...
						<div class="row">
							<div class="col-md-10 col-sm-12">
								<div class="form-group <?php if(form_error('leave-name')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_input(array(
											...
											'value' => set_value('leave-name', $info->leave_name),
											'required' => 'true'
										));
								...
								<div class="form-group <?php if(form_error('leave-code')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_input(array(
											...
											'value' => set_value('leave-code', $info->leave_code),
											'required' => 'true'
										));
								...
								<div class="form-group <?php if(form_error('leave-limit')) echo 'has-error'; ?>">
									...
									<div class="col-sm-9">
										...
										echo form_input(array(
											...
											'value' => set_value('leave-limit', $info->leave_limit),
											'required' => 'true'
										));
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div class="i-checks">
											<label> <?php echo form_radio('salary-deduct', '1', $info->salary_deduct == '1' ? true:false)." Yes "; ?> </label>
										</div>
										<div class="i-checks">
											<label> <?php echo form_radio('salary-deduct', '0', $info->salary_deduct == '0' ? true:false)." No "; ?> </label>
										</div>
									</div>
								</div>
									...
									<?php echo form_label('Deduction Value <small class="text-danger">*</small>', 'deduction-value', array('class' => 'col-sm-3 control-label')); ?>
										<div class="col-sm-9">
											...
											echo form_input(array(
												...
												'class' => 'form-control',
												'placeholder' => 'Leave Name',
												'value' => set_value('deduction-value', $info->deduction_value)
											)); ?>
